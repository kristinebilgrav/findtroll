...
#python path/to/script path/to/input/file path/to/output/file/startname

python /proj/nobackup/sens2017106/kristine/SVDB/find_exons.py $1 /proj/nobackup/sens2017106/kristine/SVDB/$2/$2
python /proj/nobackup/sens2017106/kristine/SVDB/find_tfs.py /proj/nobackup/sens2017106/kristine/SVDB/$2/$2_VEP_exons.vcf /proj/nobackup/sens2017106/kristine/SVDB/$2/$2
