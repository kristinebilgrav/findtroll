...
filename = sys.argv[2] + "_segduptmp.vcf" 
fileOutput = open(sys.argv[2] + "_VEP_exons_tfs_segdup.vcf", "w")
...
for l in open(sys.argv[1]):
    ...
    #print("tabix /proj/nobackup/sens2017106/wharf/kbilgrav/kbilgrav-sens2017106/ENCODE/SegDup_hg19_nochr.bed.gz " + search + " " + ">" + " " + filename )
    os.system("tabix /proj/nobackup/sens2017106/wharf/kbilgrav/kbilgrav-sens2017106/ENCODE/SegDup_hg19_nochr.bed.gz " + search + " " + ">" + " " + filename ) 
